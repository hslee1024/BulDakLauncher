...
remote.getCurrentWebContents().on('devtools-opened', () => {
    ...
    console.log('%c2. 바탕화면, 다운로드 폴더와 같이 찾기 쉬운 폴더에 파일명을 "(카페 닉네임)_(YYYY.MM.DD. (날짜)).log"의 형식으로 저장해 주세요.', 'font-size: 10px')
    console.log('%c3. 다운로드 한 파일을 공식 네이버 카페(https://cafe.naver.com/buldak3/) 의 버그 제보 게시판에 비밀글로(운영진만 볼 수 있도록) 올려주세요.', 'font-size: 10px')
